...
?>
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo ( $hidden ) ? 'style="display:none;"' : ''; ?> data-barba-prevent="all">
    ...
    <div class="mb-3 card">
        ...
        <div class="card-body">
            ...
            <p class="mt-3 mb-0 lost_password">
