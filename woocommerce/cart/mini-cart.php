...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<div class="woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>" data-barba-prevent="all">
		<?php
				...
				<div class="woocommerce-mini-cart-item border-top <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
                    ...
                    <div class="py-3">
                        ...
                        <div class="row">
                            ...
                            <div class="text-right remove col-2">
...
<div class="text-center cart-footer border-top">
    
    <div class="py-3">

	<p class="mb-1 woocommerce-mini-cart__total total lead">
		<?php
		/**
