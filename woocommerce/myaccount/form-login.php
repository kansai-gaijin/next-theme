...
<div class="row" id="customer_login" data-barba-prevent="all">
    ...
    <div class="col-md-6">
        ...
        <div class="mt-3 mb-4 card">
            ...
            <form class="card-body" method="post">
                ...
                <p class="mt-3 mb-0 woocommerce-LostPassword lost_password">
    ...
    <div class="col-md-6">
        ...
        <div class="mt-3 card">
            ...
            <form method="post" class="card-body" <?php do_action( 'woocommerce_register_form_tag' ); ?>>
                ...
                <p class="mb-3 woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
